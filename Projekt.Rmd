...
Aby jednak tego dokonać zastosujemy dekompozycję SVD badanej macierzy standaryzowanych reszt pearsonowskich $E$, czyli rozkład według wartości osobliwych macierzy kwadratowej $E\cdot E^T$. Skorzystamy z gotowej funkcji svd:
...
Na podstawie powyższych wykresów jesteśmy w stanie odczytać, iż 32 okrąg wyborczy(w województwie śląskim) wykazuje szczególne poparcie dla Lewicy, okręgi 19(Warszawa) i 39(Poznań) wykazują poparcie przede wszystkim dla Koalicji Obywatelskiej. Podobnie możemy odczytać resztę zależności.
...
Przeprowadzimy dalej analizę korespondencji bez odstających partii politycznych.
